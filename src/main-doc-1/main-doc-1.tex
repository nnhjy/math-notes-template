...
First paragraph is not indent by default. In ordinary text, we can write $\mathbi{a} \in \R$, compared with $\mathbf{a} \in \R$.

\mydef \cite{einstein} is an in-text citation.

Text following theorem denotation are italic by default.

\rm % Remove the above formatting for all following text.
